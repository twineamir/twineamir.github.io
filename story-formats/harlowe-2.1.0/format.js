window.storyFormat({
	...
	"setup": function () {
		...
		(function () {
			...
			function n(e, r, n, t) {
				return !(e.canFollow && !(e.canFollow.indexOf(n && n.type) > -1) || e.cannotFollow && (-1 !== e.cannotFollow.indexOf(n && n.type) || e.cannotFollow.indexOf("text") > -1 && t) || e.peek && e.peek.toLowerCase() !== r.slice(0, e.peek.length).toLowerCase())
			}

			function t(e) {
				for (var r = e.innerText, t = [], o = 0, s = o, u = r.length, l = null; u > o;) {
					for (var m = r.slice(o), c = (t.length ? t[0] : e).innerMode, g = 0, p = c.length; p > g; g += 1) {
						var d = i[c[g]];
						if (n(d, m, l, o > s) && d.pattern.test(m)) {
							var h = d.pattern.exec(m),
								f = d.fn(h),
								y = !1,
								k = 0;
							if (f.matches) {
								for (; k < t.length; k += 1) {
									...
									0 === b.indexOf("verbatim") && (b = "verbatimOpener"), f.cannotCross && f.cannotCross.indexOf(b) > -1 && (k = t.length - 1)
								}
							...
							o > s && e.addChild({
								...
								text: r.slice(s, o),
								innerMode: c
							}), l = e.addChild(f), o += l.text.length, s = o, y && (a(e, l, t[k]), t = t.slice(k + 1)), l.isFrontToken() && t.unshift(l);
							break
						}
					}
					g === p && (o += 1, null === l && (l = {
			...
			function a(e, n, t) {
				...
				n.children = e.children.splice(o + 1, a - (o + 1)), n.children.forEach(function (e) {
					r(n, e)
				}), n.type = n.matches[t.type], n.innerText = "";
				for (var i = 0, s = n.children.length; s > i; i++) n.innerText += n.children[i].text;
				n.start = t.start, n.text = t.text + n.innerText + n.text, Object.keys(t).forEach(function (e) {
					Object.hasOwnProperty.call(n, e) || (n[e] = t[e])
				}), n.isFront && (n.isFront = !1), e.children.splice(o, 1), r(e, n)
			}
			var o = void 0,
				i = {};
			e.prototype = {
				...
				nearestTokenAt: function (e) {
					return e < this.start || e >= this.end ? null : this.children ? this.children.reduce(function (r, n) {
						return r || (e >= n.start && e < n.end ? n : null)
					}, null) : this
				},
				everyLeaf: function (e) {
					return this.children && 0 !== this.children.length ? this.children.reduce(function (r, n) {
			...
			function () {
				function e(r) {
					return r && "object" === ("undefined" == typeof r ? "undefined" : _typeof(r)) ? (Object.keys(r).forEach(function (n) {
						r[n] = e(r[n])
					}), r) : (r + "").replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
				}
				...
				var t = void 0,
					...
					I = "<<[^>\\s]+\\s*(?:\\\\.|'(?:[^'\\\\]*\\\\.)*[^'\\\\]*'|\"(?:[^\"\\\\]*\\\\.)*[^\"\\\\]*\"|[^'\"\\\\>]|>(?!>))*>>",
					D = a("=<", "=>", "[gl]te?" + l, "n?eq" + l, "isnot" + l, "are" + l, "x" + l),
					E = {
						name: "[a-zA-Z][\\w\\-]*",
						attrs: "(?:\"[^\"]*\"|'[^']*'|[^'\">])*?"
					},
					...
					q = "_(" + x + ")" + l,
					$ = "\\b(\\d+(?:\\.\\d+)?(?:[eE][+\\-]?\\d+)?)" + o("m?s") + l;
				v.main = v.opener + a(v.text + v.rightSeparator, v.text.replace("*", "*?") + v.leftSeparator) + v.text, t = {
					...
					tag: "<\\/?" + E.name + E.attrs + ">",
					tagPeek: "<",
					scriptStyleTag: "<(" + a("script", "style") + ")" + E.attrs + ">[^]*?<\\/\\1>",
					scriptStyleTagOpener: "<",
					url: "(" + a("https?", "mailto", "javascript", "ftp", "data") + ":\\/\\/[^\\s<]+[^<.,:;\"')\\]\\s])",
					bullet: f,
					hr: N,
					heading: C,
					align: T,
					...
					collapsedBack: "}",
					hookAppendedFront: "\\[",
					hookPrependedFront: _ + "\\[",
					hookFront: "\\[",
					hookBack: "\\]" + o(R),
					hookAppendedBack: "\\]" + R,
					passageLink: v.main + v.closer,
					passageLinkPeek: "[[",
					legacyLink: v.opener + v.legacyText + v.legacySeparator + v.legacyText + v.closer,
					legacyLinkPeek: "[[",
					simpleLink: v.opener + v.legacyText + v.closer,
					simpleLinkPeek: "[[",
					macroFront: V.opener + i(V.name),
					macroFrontPeek: "(",
					macroName: V.name,
					groupingFront: "\\(" + o(V.name),
					groupingFrontPeek: "(",
					groupingBack: "\\)",
					twine1Macro: I,
					twine1MacroPeek: "<<",
					...
					propertyPeek: "'s",
					belongingProperty: O,
					possessiveOperator: F,
					belongingOperator: L,
					belongingOperatorPeek: "of",
					itsOperator: j,
					itsOperatorPeek: "its",
					belongingItOperator: M,
					...
					hookRef: "\\?(" + g + "+)\\b",
					hookRefPeek: "?",
					cssTime: "(\\d+\\.?\\d*|\\d*\\.?\\d+)(m?s)" + l,
					colour: a(a("Red", "Orange", "Yellow", "Lime", "Green", "Cyan", "Aqua", "Blue", "Navy", "Purple", "Fuchsia", "Magenta", "White", "Gray", "Grey", "Black"), "#[\\dA-Fa-f]{3}(?:[\\dA-Fa-f]{3})?"),
					number: $,
					boolean: a("true", "false") + l,
					identifier: P,
					itsProperty: H,
					itsPropertyPeek: "its",
					belongingItProperty: B,
					escapedStringChar: "\\\\[^\\n]",
					singleStringOpener: "'",
					doubleStringOpener: '"',
					is: "is" + o(u + "not", u + "in", u + "<", u + ">") + l,
					isNot: "is" + u + "not" + l,
					and: "and" + l,
					or: "or" + l,
					not: "not" + l,
					inequality: "((?:is(?:" + u + "not)?" + s + ")*)(" + a("<(?!=)", "<=", ">(?!=)", ">=") + ")",
					isIn: "is" + u + "in" + l,
					contains: "contains" + l,
					addition: e("+") + o("="),
					subtraction: e("-") + o("="),
					...
					augmentedAssign: a("\\+", "\\-", "\\*", "\\/", "%") + "=",
					incorrectOperator: D
				}, "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) ? module.exports = t : "function" == typeof define && define.amd ? define("patterns", [], function () {
					return t
				}) : this && this.loaded ? (this.modules || (this.modules = {}), this.modules.Patterns = t) : this.Patterns = t
			}.call(eval("this") || ("undefined" != typeof global ? global : window)),
			function () {
				function e(e) {
					function r(e) {
					...
					function a(e, r) {
						return Object.keys(r).forEach(function (n) {
							...
							r[n].fn = function (r) {
								var a = t(r);
								return a.text || (a.text = r[0]), a.type || (a.type = n), a.innerMode || (a.innerMode = e), a
							}
						}), r
					}
							...
							align: {
								fn: function (e) {
									var r = void 0,
										n = e[1],
										t = n.indexOf("><");
									return ~t ? (r = Math.round(t / (n.length - 2) * 50), 25 === r && (r = "center")) : "<" === n[0] && ">" === n.slice(-1) ? r = "justify" : n.indexOf(">") > -1 ? r = "right" : n.indexOf("<") > -1 && (r = "left"), {
										align: r
									}
								}
							},
							column: {
								fn: function (e) {
									var r = void 0,
										n = e[1],
										t = n.indexOf("|");
									return t && t < n.length - 1 ? r = "center" : "|" === n[0] && "|" === n.slice(-1) ? r = "none" : t === n.length - 1 ? r = "right" : t || (r = "left"), {
										column: r,
					...
					var l = a(i, {
							...
							boldOpener: {
								fn: t("boldOpener", "bold")
							},
							italicOpener: {
								fn: t("italicOpener", "italic")
							},
							strikeOpener: {
								fn: t("strikeOpener", "strike")
							},
							supOpener: {
								fn: t("supOpener", "sup")
							},
						...
						c = a(s, Object.assign({
							...
							colour: {
								...
								fn: function (e) {
									...
									return r = Object.hasOwnProperty.call(t, n) ? "#" + t[n] : n, {
										colour: r
									}
								}
							},
							...
							incorrectOperator: {
								fn: function (e) {
									...
									return {
										type: "error",
										message: "Please say " + (r ? "'" + r + "'" : "something else") + " instead of '" + e[0] + "'."
									}
								},
								cannotFollow: "text"
							}
						}, ["boolean", "is", "to", "into", "where", "via", "with", "making", "each", "and", "or", "not", "isNot", "contains", "isIn"].reduce(function (e, r) {
							return e[r] = {
								fn: o,
								cannotFollow: ["text"]
							}, e
						}, {}), ["comma", "spread", "addition", "subtraction", "multiplication", "division"].reduce(function (e, r) {
							return e[r] = {
								fn: o
							}, e
						}, {})));
					i.push.apply(i, _toConsumableArray(Object.keys(u)).concat(_toConsumableArray(Object.keys(m)), _toConsumableArray(Object.keys(l)))), s.push.apply(s, _toConsumableArray(Object.keys(m)).concat(_toConsumableArray(Object.keys(c))));
					var g = Object.assign({}, u, l, m, c);
					return Object.keys(g).forEach(function (e) {
						var r = n[e];
						g[e].pattern = "string" != typeof r ? r : new RegExp("^(?:" + r + ")", "i"), n[e + "Peek"] && (g[e].peek = n[e + "Peek"])
					}), Object.assign(e.rules, g), e.modes.start = e.modes.markup = i, e.modes.macro = s, e
				}
				...
				Object.assign = Object.assign || function (e) {
					...
					return e
				}, "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) ? (n = require("./patterns"), module.exports = r(require("./lexer"))) : "function" == typeof define && define.amd ? define("markup", ["lexer", "patterns"], function (e, t) {
					return n = t, r(e)
				}) : this && this.loaded && this.modules ? (n = this.modules.Patterns, this.modules.Markup = r(this.modules.Lexer)) : (n = this.Patterns, this.TwineMarkup = r(this.TwineLexer))
			}.call(eval("this") || ("undefined" != typeof global ? global : window)),
			function () {
				var e = function (e) {
					...
					n = r instanceof Object && Object.keys(r).reduce(function (e, n) {
						return e.concat.apply(e, [r[n].name].concat(_toConsumableArray(r[n].aka)))
					}, []).map(e),
					t = void 0;
				"function" == typeof define && define.amd ? define("markup", [], function (e) {
					t = e.lex
				}) : this && this.loaded && this.modules && (t = this.modules.Markup.lex), window.CodeMirror && CodeMirror.defineMode("harlowe-2", function () {
					function r(e, r) {
						if (e.update) {
							var n = e.from.line,
								t = r.split("\n").slice(0, e.from.line + 1);
							return t[n] = t[n].slice(0, e.from.ch) + e.text[0], t = t.concat(e.text.slice(1)), e.update({
								line: 0,
								ch: 0
							}, e.to, t), t.join("\n")
						}
					...
					function a(e) {
						...
						if (r) {
							if (u.push(e.markText(e.posFromIndex(r.start), e.posFromIndex(r.end), {
									className: "cm-harlowe-2-cursor"
								})), "variable" === r.type || "tempVariable" === r.type || "hookRef" === r.type || "hook" === r.type) {
								var n = "hook" === r.type ? "hookRef" : r.type;
								s[n].forEach(function (n) {
									n !== r && n.name === r.name && u.push(e.markText(e.posFromIndex(n.start), e.posFromIndex(n.end), {
										className: "cm-harlowe-2-variableOccurrence"
									}))
								})
							}("hookRef" === r.type || "hook" === r.type) && s.hook.forEach(function (n) {
								if (n !== r && n.name === r.name) {
									var t = "appended" === n.tagPosition ? n.end - n.name.length - 1 : n.start + 1;
									u.push(e.markText(e.posFromIndex(t), e.posFromIndex(t + n.name.length), {
					...
					var o = void 0,
						...
						s = {
							...
							populate: function () {
								var e = this;
								this.variable = [], this.tempVariable = [], this.hook = [], this.hookRef = [];
								var r = function r(n) {
									("variable" === n.type || "tempVariable" === n.type || "hook" === n.type || "hookRef" === n.type) && e[n.type].push(n), n.children.forEach(r)
								};
					...
					return {
						...
						token: function (r, t) {
							...
							for (; o === o.tokenAt(t.pos) && !r.eol();) t.pos++, r.next();
							r.eol() && t.pos++;
							for (var s = {}, u = "", m = 0; m < a.length; m += 1) {
								var c = a[m].type,
									g = "harlowe-2-" + c;
								switch (s[g] = (s[g] || 0) + 1, s[g] > 1 && (g += "-" + s[g]), c) {
									case "macroName":
										-1 === n.indexOf(e(a[m].text.slice(0, -1))) && (g += " harlowe-2-error")
								}
								u += g + " "
							}
							return u
				...
				var a = document.querySelector("style#cm-harlowe-2");
				a || (a = document.createElement("style"), a.setAttribute("id", "cm-harlowe-2"), document.head.appendChild(a)), a.innerHTML = function () {
					var e = function (e, r, n) {
							return function (t) {
								return "background-color: hsla(" + e + "," + r + "%," + n + "%," + t + ");"
							}
						},
						r = e(40, 100, 50),
						n = e(220, 100, 50),
						...
						a = "color: firebrick !important; background-color: hsla(17, 100%, 74%, 0.74) !important;",
						o = "font-weight:100; color: hsla(0,0,0,0.5)";
					return {
						root: "box-sizing:border-box;",
						"cursor:not([class^='cm-harlowe-2-text cm-harlowe-2-root'])": "border-bottom: 2px solid darkgray;",
						...
						"error:not([class*='cm-harlowe-2-string'])": a,
						macro: t(.05),
						"macro-2": t(.1),
						"macro-3": t(.15),
						"macro-4": t(.2),
						...
						"^=bold, ^=strong, ^=italic, ^=em, ^=sup, ^=verbatim, ^=strike": o,
						"^=string": "font-style:italic; display:inline-block; transform: scaleX(-1);",
						"string + ^=string": "transform: none;",
						"^=collapsed": "font-weight:bold; color: hsl(201, 100%, 30%);",
						collapsed: n(.025),
						"collapsed.hook": n(.05),
						"collapsed.hook-2": n(.1),
						"collapsed.hook-3": n(.15),
						"collapsed.hook-4": n(.2),
						"collapsed.hook-5": n(.25),
						"collapsed.hook-6": n(.3),
						"collapsed.hook-7": n(.35),
						"collapsed.hook-8": n(.4),
						...
						tempVariable: "color: #1a6e97;",
						hookRef: "color: #007f54;",
						"variableOccurrence, hookOccurrence": "background: #9fdfc9 !important;",
						where: "color: #007f00; font-style:italic;",
						via: "color: #007f00; font-style:italic;",
						with: "color: #007f00; font-style:italic;",
						making: "color: #007f00; font-style:italic;",
						each: "color: #007f00; font-style:italic;",
						heading: "font-weight:bold;",
						hr: "display:block; background-image: linear-gradient(0deg, transparent, transparent 45%, silver 45%, transparent 55%, transparent);",
						align: "display:block; color: hsl(14, 99%, 37%); background-color: hsla(14, 99%, 87%, 0.2);",
						column: "display:block; color: hsl(204, 99%, 37%); background-color: hsla(204, 99%, 87%, 0.2);",
						escapedLine: "font-weight:bold; color: hsl(51, 100%, 30%);",
						"identifier, property, belongingProperty, itsProperty, belongingItProperty, belongingItOperator": "color: #0076b2;",
						toString: function () {
							var e = this;
							return Object.keys(this).reduce(function (r, n) {
								var t;
								return "toString" === n ? r : "CodeMirror" === n.slice(0, 10) ? r + "." + n + "{" + e[n] + "}" : (t = n.split(", ").map(function e(r) {
									return r.indexOf(".") > -1 ? r.split(/\./g).map(e).join("") : r.indexOf(" + ") > -1 ? r.split(/ \+ /g).map(e).join(" + ") : 0 === r.indexOf("^=") ? "[class^='cm-harlowe-2-" + r.slice(2) + "']" : ".cm-harlowe-2-" + r
								}), r + t.join(", ") + "{" + e[n] + "}")
							}, "")
						}
					} + ""
